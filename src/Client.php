...
class Client
{
    ...
    public function __construct($accountId, $applicationKey, array $options = array())
    {
        ...
        if (isset($options['client'])) {
            ...
            $this->client = new HttpClient(array('exceptions' => false));
        }
    ...
    {
        if (!in_array($options['BucketType'], array(Bucket::TYPE_PUBLIC, Bucket::TYPE_PRIVATE))) {
            throw new ValidationException(
                sprintf('Bucket type must be %s or %s', Bucket::TYPE_PRIVATE, Bucket::TYPE_PUBLIC)
            );
        }

        $response = $this->client->request('POST', $this->apiUrl . '/b2_create_bucket', array(
            'headers' => array(
    ...
    public function updateBucket(array $options)
    {
        ...
        $response = $this->client->request('POST', $this->apiUrl . '/b2_update_bucket', array(
            'headers' => array(
                'Authorization' => $this->authToken,
            ),
            'json' => array(
    ...
    public function listBuckets()
    {
        ...
        $response = $this->client->request('POST', $this->apiUrl . '/b2_list_buckets', array(
            'headers' => array(
                'Authorization' => $this->authToken,
            ),
            'json' => array(
    ...
    public function deleteBucket(array $options)
    {
        ...
        $this->client->request('POST', $this->apiUrl . '/b2_delete_bucket', array(
            'headers' => array(
                'Authorization' => $this->authToken,
            ),
            'json' => array(
    ...
    public function upload(array $options)
    {
        ...
        $response = $this->client->request('POST', $this->apiUrl . '/b2_get_upload_url', array(
            'headers' => array(
                'Authorization' => $this->authToken,
            ),
            'json' => array(
        ...
        $response = $this->client->request('POST', $uploadEndpoint, array(
            'headers' => array(
    ...
    public function listFiles(array $options)
    {
        ...
        while (true) {
            $response = $this->client->request('POST', $this->apiUrl . '/b2_list_file_names', array(
                'headers' => array(
                    'Authorization' => $this->authToken,
                ),
                'json' => array(
    ...
    public function getFile(array $options)
    {
        ...
        $response = $this->client->request('POST', $this->apiUrl . '/b2_get_file_info', array(
            'headers' => array(
                'Authorization' => $this->authToken,
            ),
            'json' => array(
    ...
    public function deleteFile(array $options)
    {
        ...
        $this->client->request('POST', $this->apiUrl . '/b2_delete_file_version', array(
            'headers' => array(
                'Authorization' => $this->authToken,
            ),
            'json' => array(
    ...
    {
        $response = $this->client->request('GET', 'https://api.backblazeb2.com/b2api/v1/b2_authorize_account', array(
